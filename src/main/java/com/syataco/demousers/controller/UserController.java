 ...
 */
package com.syataco.demousers.controller;

import com.google.gson.GsonBuilder;
import com.syataco.demousers.bean.UserBean;
import com.syataco.demousers.model.User;
import com.syataco.demousers.service.UserService;
    ...
    public ResponseEntity<String> login(@PathVariable("email") String email, @PathVariable("password") String password) {
        try {
            if(userService.validateUser(email, password) != null) {
                return new ResponseEntity<>(gsonBuilder.create().toJson("User whit access"), HttpStatus.OK);                
            } else {
